...
//   int function_0x10_app_load(zm831_home_app *app);
//   int function_0x10_app_loop(zm831_home_app *app);
//   int function_0x10_app_exit(zm831_home_app *app);

//   zm831_home_app get_function_0x10_app()
//   {
//     return {function_0x10_app_load, function_0x10_app_loop, function_0x10_app_exit, &function_0x10_app};
//   }

//   // ==============================================================================================

//   static void function_0x10_btn_event_app_cb(lv_obj_t *btn, lv_event_t event)
//   {
//     // printf("btn %p event %d\n", btn, event);
//     if (function_0x10_app.ui->face_study_app_imgbtn_back == btn && event == LV_EVENT_SHORT_CLICKED)
//     {
...
//   int function_0x10_app_load(zm831_home_app *app)
//   {
//     auto self = (_function_0x10_ *)app->userdata;
...
//       lv_obj_set_event_cb(self->ui->face_study_app_imgbtn_back, function_0x10_btn_event_app_cb);
//       pthread_mutex_unlock(&zm831->ui_mutex);

//       self->init = true;
//     }
//     LIBMAIX_INFO_PRINTF("function_0x10_app_load");
//     return 0;
//   }
...
//       self->init = false;
//     }
//     LIBMAIX_INFO_PRINTF("function_0x10_app_exit");
//     return 0;
//   }
...
//     {
//       // CALC_FPS("function_0x10_app_loop"); // 224x224
//     }
//     return 0;
//   }
// }
